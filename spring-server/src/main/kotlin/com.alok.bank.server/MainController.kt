...
@RestController
//@CrossOrigin(origins="*")
@RequestMapping("/zarathos") // The paths for GET and POST requests are relative to this base path.
private class RestController(
    ...
    fun issueAssetRequest(@RequestBody params: IssueParams): ResponseEntity<String> {
        ...
        return try {
            ...
            proxy.startFlow(::AlokIssueRequest, params.thought, issuerID).returnValue.getOrThrow()
    ...
    @GetMapping("/getzarathos", produces = ["application/json"])
